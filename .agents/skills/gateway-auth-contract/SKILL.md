---
name: VITAL-APPOINTMENT Gateway/Auth Contract Checklist
description: Quick checklist for VITAL-APPOINTMENT changes that touch auth, routing, trusted headers, or role propagation.
---

# VITAL-APPOINTMENT Gateway/Auth Contract Checklist

Use this skill when work touches appointment-service auth, request routing, trusted headers, local role contribution, or direct Auth calls.
...
4. `docs/security.md`
5. `.agents/rules/appointment-gateway-auth-contract.md`
...
- Prefer `X-Internal-Service: vital-appointment` and `X-Internal-Service-Key`.
