# VITAL-APPOINTMENT Docs

This documentation set describes the current state of the `VITAL-APPOINTMENT` repository and the target integration contract it should follow inside the wider BGH platform.
...
6. [deployment.md](deployment.md): local startup, PostgreSQL helper compose usage, and future production placement
