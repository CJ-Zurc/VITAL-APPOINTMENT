---
trigger: always_on
description: Core repo-specific directives for VITAL-APPOINTMENT.
---

# VITAL Appointment: Core Directives
...
- check `.agents/rules/appointment-context-documents.md` for architectural conventions.
...
Scopes: `appointment`, `schedule`, `notification`, `api`, `db`.
